...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'Z\031velox/gRPC/recommendation',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x15recommendations.proto\x12\x0erecommendation\"m\n\x15RecommendationRequest\x12\x0f\n\x07user_id\x18\x01 \x01(\x05\x12.\n\x08\x63\x61tegory\x18\x02 \x01(\x0e\x32\x1c.recommendation.BookCategory\x12\x13\n\x0bmax_results\x18\x03 \x01(\x05\"/\n\x12\x42ookRecommendation\x12\n\n\x02id\x18\x01 \x01(\x05\x12\r\n\x05title\x18\x02 \x01(\t\"U\n\x16RecommendationResponse\x12;\n\x0frecommendations\x18\x01 \x03(\x0b\x32\".recommendation.BookRecommendation*?\n\x0c\x42ookCategory\x12\x0b\n\x07MYSTERY\x10\x00\x12\x13\n\x0fSCIENCE_FICTION\x10\x01\x12\r\n\tSELF_HELP\x10\x02\x32m\n\x0fRecommendations\x12Z\n\tRecommend\x12%.recommendation.RecommendationRequest\x1a&.recommendation.RecommendationResponseB\x1bZ\x19velox/gRPC/recommendationb\x06proto3'
)

_BOOKCATEGORY = _descriptor.EnumDescriptor(
  name='BookCategory',
  full_name='recommendation.BookCategory',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_RECOMMENDATIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='recommendation.RecommendationRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='recommendation.RecommendationRequest.user_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='category', full_name='recommendation.RecommendationRequest.category', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_results', full_name='recommendation.RecommendationRequest.max_results', index=2,
...
_BOOKRECOMMENDATION = _descriptor.Descriptor(
  ...
  full_name='recommendation.BookRecommendation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='recommendation.BookRecommendation.id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='title', full_name='recommendation.BookRecommendation.title', index=1,
...
_RECOMMENDATIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='recommendation.RecommendationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='recommendations', full_name='recommendation.RecommendationResponse.recommendations', index=0,
...
BookRecommendation = _reflection.GeneratedProtocolMessageType('BookRecommendation', (_message.Message,), {
  ...
  '__module__' : 'recommendations_pb2'
  # @@protoc_insertion_point(class_scope:recommendation.BookRecommendation)
  })
...
_RECOMMENDATIONS = _descriptor.ServiceDescriptor(
  ...
  full_name='recommendation.Recommendations',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Recommend',
    full_name='recommendation.Recommendations.Recommend',
    index=0,
